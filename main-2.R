...
n_rice <- length(data$Deliciousness[data$Deliciousness == "rice"]) # 30
# นิสิตที่ชอบรับประข้าวห้อมมะลิจำนวน 24 คน
n_thia_jasmine_rice <- length(data$RiceTypes[data$RiceTypes == "thai jasmine rice" & data$Deliciousness == "rice"]) # 24
